...
func main() {
	...
	// Match standalone "1", "2", ... "8" (chapter markers in this edition).
	...
	if len(chapterStarts) == 0 {
		fmt.Println("No chapter markers found in ordeal.txt")
		return
	}
	...
	for i := 0; i < sectionCount; i++ {
		...
		filename := fmt.Sprintf("Ordeal_Section_%d.txt", i+1)
