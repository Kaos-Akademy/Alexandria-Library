...
func main() {
	...
	// Match "CHAPTER ONE", "CHAPTER TWO", ... "CHAPTER NINE" (word form).
	...
	if len(chapterStarts) == 0 {
		fmt.Println("No chapter markers found in marazan.txt")
		return
	}
	...
	for i := 0; i < sectionCount; i++ {
		...
		filename := fmt.Sprintf("Marazan_Section_%d.txt", i+1)
