...
func main() {
	...
	// Match "CHAPTER ONE", "CHAPTER TWO", ... (word form).
	...
	if len(chapterStarts) == 0 {
		fmt.Println("No chapter markers found in disdained.txt")
		return
	}
	...
	for i := 0; i < sectionCount; i++ {
		...
		filename := fmt.Sprintf("Disdained_Section_%d.txt", i+1)
