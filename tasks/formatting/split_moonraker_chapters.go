...
func main() {
	...
	// Match standalone "CHAPTER I", "CHAPTER II", ... "CHAPTER XXV".
	...
	if len(chapterStarts) == 0 {
		fmt.Println("No chapter markers found in moonraker.txt")
		return
	}
	...
	for i := 0; i < sectionCount; i++ {
		...
		filename := fmt.Sprintf("Moonraker_Section_%d.txt", i+1)
