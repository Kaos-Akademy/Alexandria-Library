...
func main() {
	...
	// Match standalone "1", "2", ... "10" (chapter markers in this edition).
	...
	if len(chapterStarts) == 0 {
		fmt.Println("No chapter markers found in landfall.txt")
		return
	}
	...
	for i := 0; i < sectionCount; i++ {
		...
		filename := fmt.Sprintf("Landfall_Section_%d.txt", i+1)
