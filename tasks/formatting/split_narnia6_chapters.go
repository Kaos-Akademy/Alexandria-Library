...
func main() {
	...
	// Match standalone "CHAPTER I", "CHAPTER II", ... "CHAPTER XV".
	...
	if len(chapterStarts) == 0 {
		fmt.Println("No chapter markers found in narnia6.txt")
		return
	}
	...
	for i := 0; i < sectionCount; i++ {
		...
		filename := fmt.Sprintf("Narnia6_Section_%d.txt", i+1)
