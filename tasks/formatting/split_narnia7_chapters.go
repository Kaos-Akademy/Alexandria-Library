...
func main() {
	...
	// Match standalone "CHAPTER I", "CHAPTER II", ... "CHAPTER XVI".
	...
	if len(chapterStarts) == 0 {
		fmt.Println("No chapter markers found in narnia7.txt")
		return
	}
	...
	for i := 0; i < sectionCount; i++ {
		...
		filename := fmt.Sprintf("Narnia7_Section_%d.txt", i+1)
